...
class B2EStudent_detail(Base):
    ...
    atd_subjectkey = Column(Integer)  #new added field
...
class StuConAttDtl(Base):
    __tablename__ = "b2e_tbl_col_stuconatddtl"

    catdid = Column(Integer, primary_key=True, index=True)
    catd_attkey = Column(Integer)
    catdnoofhrsatdper = Column(String)
    catdnoofhrsatd = Column(String)
    catdtotalnoofhrs = Column(String)
    catd_stdid = Column(Integer)

class StuConAttHdr(Base):
    __tablename__ = "b2e_tbl_col_stuconatdhdr"    

    cattkey = Column(Integer, primary_key=True, index=True)
    catdclassid = Column(Integer)
    catdnoofhrs = Column(String)
    catdtodate = Column(DateTime)
