...
class Consolidate_AttendanceRequest(BaseModel):
    class_id: int
    batch_startdate: datetime
    batch_enddate: datetime
    bsh_semno: str  
    adpname: str    
    stu_KEY: int  


class Consolidate_AttendanceResponse(BaseModel):
    stu_KEY: int
    stu_name: str
    noofhrsatdper: int
    noofhrsatd: int
...
class Daily_AttendanceRequest(BaseModel):
    student_key: int
    class_id: int
    current_date: str    
    
    
class Attendance_dropdown(BaseModel):
    stf_key: str
    adddate: str    
